<x-app-layout>
    ...
    <div class=" h-[100%] md:h-[calc(100vh-4rem)] grid grid-cols-1 w-full md:grid-cols-2">
        <div class="flex flex-col items-center justify-center text-center ">
            <h1 class="md:font-semibold text-4xl mt-6 xl:text-6xl mb-8 p-4 text-black">
            Willkommen im  <br>
            <span class="bg-gradient-to-r from-[#1864ab] to-[#339af0] bg-clip-text text-transparent">
            Rentnerforum
            </span>
            </h1>
            <p class="text-center text-[1.2rem] m-x-[1rem] ">Ideen für den Alltag, werden Sie Teil unserer Community.</p>
            @guest
            <a
                href="{{ route('register') }}"
        ...
        <div class="bg-gray-200 m-8 rounded-[2rem] md:bg-inherit flex items-center justify-center p-12 grid md:grid-cols-3 grid-cols-2 gap-4">
            <a href="{{ url('/kochtipps') }}" class="sm:h-36 sm:w-36 hover:animate-wobble hover:bg-[#d0ebff] bg-white md:bg-inherit  flex flex-col items-center justify-center border rounded-lg md:w-full p-6 mx-auto h-full cursor-pointer  md:border border-black h-28 w-28 md:h-[10.2rem] md:w-[9.2rem]">
                <svg class="md:h-28 md:w-28 m-26 w-26 sm:-mt-0 sm:mb-4 md:mb-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0  500 500"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M416 0C400 0 288 32 288 176l0 112c0 35.3 28.7 64 64 64l32 0 0 128c0 17.7 14.3 32 32 32s32-14.3 32-32l0-128 0-112 0-208c0-17.7-14.3-32-32-32zM64 16C64 7.8 57.9 1 49.7 .1S34.2 4.6 32.4 12.5L2.1 148.8C.7 155.1 0 161.5 0 167.9c0 45.9 35.1 83.6 80 87.7L80 480c0 17.7 14.3 32 32 32s32-14.3 32-32l0-224.4c44.9-4.1 80-41.8 80-87.7c0-6.4-.7-12.8-2.1-19.1L191.6 12.5c-1.8-8-9.3-13.3-17.4-12.4S160 7.8 160 16l0 134.2c0 5.4-4.4 9.8-9.8 9.8c-5.1 0-9.3-3.9-9.8-9L127.9 14.6C127.2 6.3 120.3 0 112 0s-15.2 6.3-15.9 14.6L83.7 151c-.5 5.1-4.7 9-9.8 9c-5.4 0-9.8-4.4-9.8-9.8L64 16zm48.3 152l-.3 0-.3 0 .3-.7 .3 .7z"/></svg>
                <p class="text-xl mt-4 sm:mt-0 sm:-mt-4">Kochtipps</p>
            </a>
            <a href="{{ url('/ausflug') }}" class="sm:h-36 sm:w-36 hover:animate-wobble hover:bg-[#d0ebff] bg-[#d0ebff] bg-white md:bg-inherit  flex flex-col items-center justify-center border rounded-lg md:w-full p-6  mx-auto  h-full cursor-pointer  md:border border-black h-28 w-28 md:h-[10.2rem] md:w-[9.2rem]">
            <svg class="md:h-20 md:w-20 m-22 w-22 -mt-4 sm:-mt-0 sm:mb-4 md:mb-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0  640 640">
            ...
            <a href="{{ url('/gruppen') }}"  class="sm:h-36 sm:w-36 hover:animate-wobble hover:bg-[#d0ebff] bg-[#d0ebff] bg-white md:bg-inherit flex flex-col items-center justify-center border rounded-lg md:w-full  p-6  mx-auto  h-full cursor-pointer  md:border border-black h-28 w-28 md:h-[10.2rem] md:w-[9.2rem]">
    ...
    @endif
    <section class="h-[100vh]px-4 sm:px-12 flex flex-col items-center justify-center">
        <div >
        ...
        <div class="flex items-center align-center p-4">
            <p class="text-center mb-32 md:text-left max-w-xl md:max-w-2xl lg:max-w-4xl leading-relaxed">
                Das Rentnerforum ist im Jahr 2025 im Rahmen eines Übungsprojekts entstanden, einen Ort an dem 
                jedermann Ideeen sammeln kann oder geben darf. Das Forum soll ein lebendiger Treffpunkt für alle sein, 
                die sich für neue Ideen inspirieren wollen. Getreu dem Motto 
                <em>"Das Leben hat so viel zu bieten - man muss nur wissen was"</em>, 
                laden wir Sie ein, neue Leidenschaften zu finden. Ob interessante Bücher, neue Rezepte, 
                bereichernde Ausflüge oder praktische Alltagstricks - in unserer Gemeinschaft 
                teilen wir die schönsten Entdeckungen. Denn Aktivität ist der Schlüssel zu 
                einem vitalen, erfüllten Leben in jedem Alter.
            </p>        
        </div>
    </section>
</body>
