<x-app-layout>
    ...
    <div class="main-container grid grid-cols-[1fr] md:grid-cols-[3fr_7fr] px-4 md:overflow-y-hidden">
                ...
                <a href="{{route('helping.show', ['helfende_hand' => Str::slug($task->title),])}}" class="cursor-pointer hover:bg-gray-200 p-4 py-4 mt-4 md:bg-inherit bg-[#EAECEF] rounded-[9px]">
                    <div>
                        <div class="flex items-center font-semibold text-lg md:text-base">
                            ...
                            <h3><span class="text-gray-500 text-lg md:text-base ">{{$loop->count - $loop->index}}.</span>    {{ Str::limit($task->title, 30) }}</h3>
                        </div>
                        <div>
        ...
        {{-- Right Grid --}}
        <div class=" -mt-12 text-center leading-[3rem] order-1 md:order-2">
        <div class="flex flex-col items-center justify-center mb-8 mt-8">
            <h2 class="text-3xl sm:text-4xl md:text-5xl font-serif text-gray-900 text-center relative mb-6">
                <span class="inline-block relative mt-12">
                    ...
                    <span class="relative z-10 text-[3rem]">Helfende Hand</span>
                </span>
                <br>
            ...
            <div class="flex items-center justify-center">
                <p class="italic mx-4 -mt-4 md:-mt-0 md:block text-[1rem]  max-w-[80%] leading-tight">Bewegung hält frisch! Freiwilligenarbeit, Organisationen oder auch Private Projekte. Hier können Sie Ihr Vorhaben stellen und eventuell schon bald eine Helfende Hand finden.</p>
            </div>
            <div class="flex items-center gap-2 justify-center mt-8">
                ...
                <p class="italic text-lg">Neues Projekt</p>
            </div>       
