<x-app-layout>
    ...
    {{-- Left Grid --}}
    <div class="main-container mt-16 grid grid-cols-[1fr] md:grid-cols-[3fr_7fr]  max-h-[calc(100vh-3rem)] px-4 md:overflow-y-hidden mt-4 md:mt-0">
        <div class="book-container flex flex-col gap-2 md:border-r md:border-gray-300 order-2 md:order-1 max-h-[calc(100vh-3rem)] md:overflow-y-auto overflow-y-visible scroll-container ">
        ...
        {{-- Right Grid --}}
            ...
            <div class="md:p-12 p-6 -mt-12 text-center leading-[3rem] order-1 md:order-2">
                ...
                <div class="flex itmes-center justify-center">
                    <p class="italic mx-4 -mt-4 md:-mt-0 md:block text-center text-[1rem] max-w-[80%] leading-tight"> Was gibt es besseres als ein gutes Buch? Hier können Sie ihre lieblings Bücher rekommendieren und beschreiben um was es sich im Buch handelt.</p>
                </div>
                <div class="flex items-center gap-2 justify-center mt-8">
                    ...
                    <p class="italic text-lg">Neuer Buchtipp</p>
                </div>                
                <div class="flex flex-row align-center justify-center mt-8 p-4 -ml-8  md:-ml-0">
                    ...
                    <img class="md:h-36 md:w-36 h-24 w-24 object-cover rounded-full -mr-12 border-white border-4   "  src="{{asset('imgs/books/und-immer-wieder-versailles-gebundene-ausgabe-alexander-sosnowski.jpg')}}" alt="Bild einer Buchempfehlung">
    ...
    <div class="">
        ...
        @auth
            <form  action="{{route('book.store')}}"class="grid grid-rows-[2fr_8fr] book-form" method="POST">
                @csrf
                <div class="flex items-center justify-between mt-4">
                    <div class="flex md:flex-row flex-col imtes-center justify-center gap-4 w-[100%]">
                        <div class="relative flex md:flex-row flex-col imtes-center ustify-center gap-2 md:gap-4 w-[100%]">
                            ...
                            <div  class="hidden title-error absolute top-[2.3rem] left-[16%] text-red-500 w-[10rem]">Titel angeben</div>
                            ...
                            <div class="relative">
                                ...
                                <div class="absolute top-[3rem] w-[14rem] left-[0%] rounded-l author-results bg-[#F2F2F2]"></div>
                                <div  class="hidden author-error absolute top-[2.3rem] left-[0%] text-red-500 w-[10rem]">Author angeben</div>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-row gap-4">
                            ...
                            <div class="flex flew-row whitespace-nowarp items-center justify-center md:hidden block">
                                ...
                                <select  class="rounded-xl outline-none focus:ring-0 focus:outline-none focus:border-gray-500 md:w-[60%] w-[35%] w-full h-full" name="cathegory"  id="cathegory">
                                    ...
                                    <option value="Abeteuerliteratur">Abeteuerliteratur</option>
                ...
                <div class="mt-4 h-[100%]">
                    ...
                    <textarea required class="rounded-xl outline-none focus:ring-0 focus:outline-none focus:border-gray-500 h-[25%] w-[100%] md:w-[100%] md:h-[60%]" name="description"  id="description"></textarea>
                    <button
                    type="submit"
                    class=" submit-form md:mt-2 px-6 py-2 w-[30%] rounded-full bg-blue-500 text-white font-semibold shadow-md hover:from-blue-600 hover:to-yellow-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-400 transition-all duration-300">Teilen
                </button>            
            </div>
            </form>
        @endauth
    ...
    <script>
        ...
        const createBookForm = document.querySelector('.book-form')
    ...
    //CHECK AUTHORS
        ...
        authorInput.addEventListener('input', () => authorSearch(authorInput.value))
            ...
            const exists = Object.values(bookTitles).some(c => c.title.toLowerCase() === input.toLowerCase())
