<x-app-layout>
    ...
    <div class="main-container grid grid-cols-[1fr] md:grid-cols-[3fr_7fr] px-4 md:overflow-y-hidden">
        <div class="mb-2 flex flex-col gap-2 md:border-r md:border-gray-300 order-2 md:order-1 max-h-[calc(100vh-3rem)] md:overflow-y-auto overflow-y-visible scroll-container ">
            @foreach ($posts as $post)
                <a href="{{route('groupPost.show', ['groupSlug' => $thema->title_slug, 'groupPostSlug' => Str::slug($post->title_slug)])}}" class="cursor-pointer hover:bg-gray-200 p-4 py-4 mt-4 md:bg-inherit bg-[#EAECEF] rounded-[9px]">
                    <div>
                        <div class="flex items-center font-semibold text-lg md:text-base">
                            <svg class="h-5 w-5 mr-2 opacity-60 am:mt-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><!--!Font Awesome Free v7.0.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M320 312C386.3 312 440 258.3 440 192C440 125.7 386.3 72 320 72C253.7 72 200 125.7 200 192C200 258.3 253.7 312 320 312zM290.3 368C191.8 368 112 447.8 112 546.3C112 562.7 125.3 576 141.7 576L498.3 576C514.7 576 528 562.7 528 546.3C528 447.8 448.2 368 349.7 368L290.3 368z"/></svg>
        ...
        <div class="flex flex-col items-center justify-center mt-8">
            <h2 class="text-3xl sm:text-4xl md:text-5xl font-serif text-gray-900 text-center relative mb-6">
                <span class="inline-block relative mt-12">
                    ...
                    <span class="relative z-10 text-[3rem]">{{$thema->title}}</span>
                </span>
                <br>
            ...
            <div class="flex items-center justify-center">`
                <img class="md:h-64 md:w-64 h-56 w-56 z-10 "  src="{{asset('imgs/undraw_things-to-say_f5mi.svg')}}" alt="">
            </div>
    ...
    <div class=" mt-24 md:mt-0">
        <div class=" modal hidden m-8 p-8 md:m-24 md:h-[65%] md:w-[60%] rounded-xl w-[90%] h-[65%] bg-white fixed inset-0 top-[40%] md:top-[30%] left-[45%] transform -translate-x-1/2 -translate-y-1/2  z-50">
            ...
            <form class="grid grid-rows-[2fr_8fr]" method="POST" action="{{route('groupPost.store', ['groupSlug' => $thema->title_slug])}}">
                @csrf
                <div class="flex items-center justify-between mt-4">
                    <div class="flex flex-row imtes-center ustify-center gap-4 w-[100%] md:w-[80%]">
